#undef BULLCOWGAME_API
#undef BULLCOWGAME_VTABLE
...
#define UE_PROJECT_NAME BullCowGame
...
#define BULLCOWGAME_VTABLE DLLEXPORT_VTABLE
#define BULLCOWGAME_API DLLEXPORT
